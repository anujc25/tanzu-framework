...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *K8sDiscovery) DeepCopyInto(out *K8sDiscovery) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new K8sDiscovery.
func (in *K8sDiscovery) DeepCopy() *K8sDiscovery {
	if in == nil {
		return nil
	}
	out := new(K8sDiscovery)
	in.DeepCopyInto(out)
	return out
}
