...
func (in *Catalog) DeepCopyInto(out *Catalog) {
	*out = *in
	...
	if in.Index != nil {
		...
		*out = make(map[PluginName]MapInstallationPathToPluginDescriptor, len(*in))
		for key, val := range *in {
			var outVal map[PluginInstallationPath]PluginDescriptor
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
				*out = make(MapInstallationPathToPluginDescriptor, len(*in))
				for key, val := range *in {
	...
	if in.StandAlonePlugins != nil {
		...
		*out = make(map[PluginName]PluginInstallationPath, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if in.ServerPlugins != nil {
		...
		*out = make(map[string]MapPluginNameToInstallationPath, len(*in))
		for key, val := range *in {
			var outVal map[PluginName]PluginInstallationPath
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
				*out = make(MapPluginNameToInstallationPath, len(*in))
				for key, val := range *in {
					(*out)[key] = val
				}
			}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in MapInstallationPathToPluginDescriptor) DeepCopyInto(out *MapInstallationPathToPluginDescriptor) {
	{
		in := &in
		*out = make(MapInstallationPathToPluginDescriptor, len(*in))
		for key, val := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MapInstallationPathToPluginDescriptor.
func (in MapInstallationPathToPluginDescriptor) DeepCopy() MapInstallationPathToPluginDescriptor {
	if in == nil {
		return nil
	}
	out := new(MapInstallationPathToPluginDescriptor)
	in.DeepCopyInto(out)
	return *out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in MapPluginNameToInstallationPath) DeepCopyInto(out *MapPluginNameToInstallationPath) {
	{
		in := &in
		*out = make(MapPluginNameToInstallationPath, len(*in))
		for key, val := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MapPluginNameToInstallationPath.
func (in MapPluginNameToInstallationPath) DeepCopy() MapPluginNameToInstallationPath {
	if in == nil {
		return nil
	}
	out := new(MapPluginNameToInstallationPath)
	in.DeepCopyInto(out)
	return *out
}
