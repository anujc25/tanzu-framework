...
push-management-package-bundles: tools ## Push management package bundles
	PACKAGE_REPOSITORY="management" REGISTRY=$(OCI_REGISTRY) $(PACKAGES_SCRIPTS_DIR)/package-utils.sh push_package_bundles
...
push-management-package-repo-bundles: tools push-management-package-bundles ## Push management package repo bundles
	PACKAGE_REPOSITORY="management" REGISTRY=$(OCI_REGISTRY) $(PACKAGES_SCRIPTS_DIR)/package-utils.sh push_package_repo_bundles
...
management-package-repos-bundles: tools management-package-bundles ## Build tar bundles for package repos
	PACKAGE_REPOSITORY="management" REGISTRY=$(OCI_REGISTRY) $(PACKAGES_SCRIPTS_DIR)/package-utils.sh create_package_repo_bundles
