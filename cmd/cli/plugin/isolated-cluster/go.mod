module github.com/vmware-tanzu/tanzu-framework/cmd/cli/plugin/isolated-cluster
...
require (
	...
	github.com/vmware-tanzu/tanzu-plugin-runtime v0.0.2-0.20230324033521-a110e57a60b9
